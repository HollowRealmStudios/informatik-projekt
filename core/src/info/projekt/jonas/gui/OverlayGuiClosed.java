...
public class OverlayGuiClosed extends Layer implements IHandlesActiveUpdates {
	...
	private final Widget[] widgets = new Widget[]{
			...
			new ImageButton(() -> LayerSupervisor.LAYER_STACK.push(new LayerRequest(OverlayGuiOpened.class, OVERLAY_LAYER, true)), 50, 50, 100, 100, TextureLoader.getTexture("Up.png"))
	};

	public OverlayGuiClosed() {
